<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deldown.aspx.cs" Inherits="Quiz_Project.deldown" %>
          ...
          <div class="card mb-3">
            ...
            <div class="col-lg-3">
              <table class="table">
                 <tr>
                     <td>
                          <asp:Button ID="Button1" CssClass="btn btn-outline-success" runat="server" Text="Download Result" OnClick="Button1_Click" />
                         <asp:GridView ID="GridView1" runat="server"></asp:GridView>
                    
                     </td>
                     <td>
                         <asp:Button ID="btn1" CssClass="btn btn-outline-danger" runat="server" Text="Delete" OnClick="btn1_Click" />
                     </td>
                 </tr>
               </table>
